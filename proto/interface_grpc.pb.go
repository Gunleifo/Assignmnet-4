...
type TokenRingClient interface {
	SendToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Reply, error)
}
...
func (c *tokenRingClient) SendToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/proto.TokenRing/SendToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TokenRingServer interface {
	SendToken(context.Context, *Token) (*Reply, error)
...
func (UnimplementedTokenRingServer) SendToken(context.Context, *Token) (*Reply, error) {
...
func _TokenRing_SendToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Token)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TokenRingServer).SendToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TokenRing/SendToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenRingServer).SendToken(ctx, req.(*Token))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TokenRing_SendToken_Handler,
		},
	},
